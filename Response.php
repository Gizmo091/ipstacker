...
use Zmog\Libs\IpStacker\IpStackResponsePart\ResponsePartNotAsked;
use Zmog\Libs\IpStacker\IpStackResponsePart\ResponsePartNotLoaded;
use Zmog\Libs\IpStacker\IpStackResponsePart\ResponsePartObject\Connection;
use Zmog\Libs\IpStacker\IpStackResponsePart\ResponsePartObject\Currency;
use Zmog\Libs\IpStacker\IpStackResponsePart\ResponsePartObject\Location;
use Zmog\Libs\IpStacker\IpStackResponsePart\ResponsePartObject\Security;
use Zmog\Libs\IpStacker\IpStackResponsePart\ResponsePartObject\Timezone;
use Zmog\Libs\IpStacker\IpStackResponsePart\ResponsePartValue\ValueFloat;
...
class Response {
    ...
    /** @var \Zmog\Libs\IpStacker\Request */
    protected $_Request;
    /** @var array */
    ...
    /** @var \Zmog\Libs\IpStacker\IpStackResponsePart\ResponsePartObject\Location multiple location-related objects */
    protected $_location;
    /** @var \Zmog\Libs\IpStacker\IpStackResponsePart\ResponsePartObject\Timezone an object containing timezone-related data. */
    protected $_time_zone;
    /** @var \Zmog\Libs\IpStacker\IpStackResponsePart\ResponsePartObject\Currency an object containing currency-related data. */
    protected $_currency;
    /** @var \Zmog\Libs\IpStacker\IpStackResponsePart\ResponsePartObject\Connection an object containing connection-related data. */
    protected $_connection;
    /** @var \Zmog\Libs\IpStacker\IpStackResponsePart\ResponsePartObject\Security an object containing security-related data. */
    protected $_security;
     ...
     */
    public function Request(): \Zmog\Libs\IpStacker\Request {
